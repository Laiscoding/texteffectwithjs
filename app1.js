...
// console.log(languages.indexOf("Reactjs")); //give index take value 1
// console.log(languages.indexOf("laravel")); //give index take value -1
// console.log(languages.indexOf("Laravel")); //give index take value 3
